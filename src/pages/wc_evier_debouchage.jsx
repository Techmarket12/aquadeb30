...
const AiDiagnosticModal = ({ isOpen, onClose }) => {
  ...
  const handleAnalyze = async () => {
    ...
    const apiKey = '';
    const prompt = `Act as an expert plumber specializing in clogged drains and toilets. Analyze this customer issue: "${description}".
    Respond in JSON format ONLY.
    {
      "urgency": "Faible" | "Moyenne" | "Haute" | "Critique",
      "safety_tip": "Short immediate advice in French (e.g., Do not flush, close valve)",
      "service_detected": "Débouchage Manuel" or "Hydrocurage" or "Inspection",
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden border border-slate-200">
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-6 flex justify-between items-center text-white">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold">Diagnostic Débouchage</h3>
          </div>
          ...
          {!result ? (
            <>
              ...
              <textarea
                ...
                placeholder="Exemple : L'eau des toilettes remonte quand je tire la chasse..."
                value={description}
              ...
              >
                ...
                {loading ? 'Analyse en cours...' : "Analyser le bouchon"}
              </button>
            </>
          ) : (
...
export default function DebouchageWCEviersPage() {
    ...
    <div className="font-sans text-slate-800 antialiased bg-white selection:bg-orange-500 selection:text-white">
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex gap-6">
            <span className="flex items-center gap-2 text-green-400 font-bold">
              <CheckCircle2 className="w-3.5 h-3.5" /> Devis Gratuit sur place
            </span>
          ...
          <div className="flex gap-4">
            ...
            <span className="flex items-center gap-1 text-orange-400 font-bold">
              <Star className="w-3 h-3 fill-current" /> 4.9/5 (200+ Avis)
            </span>
          </div>
        </div>
      </div>
      ...
      <main>
        <section className="relative pt-16 pb-24 bg-slate-900 overflow-hidden">
          <div className="absolute inset-0">
            <img
              ...
              alt="Débouchage WC et canalisation"
          ...
          <div className="container mx-auto px-4 relative z-10 text-center lg:text-left">
            ...
            <p className="text-xl text-slate-300 max-w-3xl lg:max-w-2xl">
              Une <strong>canalisation bouchée</strong> paralyse votre habitation. WC qui déborde, évier bloqué ou odeurs d'égout ? 
              Nos experts interviennent en <strong>urgence</strong> avec du matériel haute pression pour un <strong>débouchage</strong> rapide, 
              propre et garanti.
            </p>
            ...
            <div className="grid lg:grid-cols-3 gap-6 mt-10 max-w-3xl lg:max-w-4xl">
              ...
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
                  <ShieldCheck className="w-5 h-5 text-green-300" /> Débouchage Garanti
                </div>
                <p className="text-slate-200 text-sm mt-2">
                  Si le bouchon n'est pas parti, vous ne payez pas l'intervention. Nous utilisons furets et haute pression.
                </p>
              </div>
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-black text-slate-900 mb-6 text-center">
              Service de <span className="text-blue-600">Débouchage</span> Complet
            </h2>
          ...
          <div className="container mx-auto px-4">
              ...
              {['WC Bouché', 'Évier de cuisine', 'Douche & Baignoire', 'Sterput / Siphon'].map((item, i) => (
                <div key={i} className="bg-slate-50 rounded-2xl p-6 shadow-sm border border-slate-100">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Débouchage efficace pour <strong>{item.toLowerCase()}</strong>. Extraction des bouchons (papier, lingettes,
                    résidus alimentaires, cheveux) et rétablissement immédiat de l'écoulement.
                  </p>
                </div>
              ))}
            </div>
            ...
            <div className="mt-12 grid lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl border border-slate-100 p-7 shadow-sm">
                <h3 className="font-black text-lg text-slate-900 mb-3">Signes d'un bouchon</h3>
                <ul className="space-y-3 text-slate-600 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                    <span>L'eau monte dangereusement dans la cuvette</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                    <span>Bruits de "glou-glou" dans les tuyaux</span>
                  </li>
                </ul>
              </div>

              <div className="bg-white rounded-2xl border border-slate-100 p-7 shadow-sm">
                <h3 className="font-black text-lg text-slate-900 mb-3">Gestes d'urgence</h3>
                <ul className="space-y-3 text-slate-600 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                    <span>Appelez-nous avant que l'eau ne déborde sur le sol</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-slate-100 p-7 shadow-sm">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                  Lingettes (non biodégradables), amas de cheveux, graisses de cuisine qui figent,
                  objets tombés (bloc WC, jouets), calcaire accumulé, ou contre-pente.
                  Nous identifions la cause pour éviter la récidive.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black text-slate-900 mb-4">
              Déroulement du <span className="text-blue-600">débouchage</span>
            </h2>
            <p className="text-slate-600 mb-12 max-w-3xl mx-auto">
              Une procédure claire pour rétablir l'écoulement de vos eaux usées en un temps record.
            </p>
            <div className="grid md:grid-cols-4 gap-8 text-left">
              {[
                ...
                },
                {
                  ...
                  d: 'Le technicien évalue la nature et la localisation du bouchon (WC, colonne, siphon).'
                },
                {
                  t: 'Devis avant travaux',
                  d: "Prix forfaitaire annoncé avant de commencer. Pas de mauvaise surprise."
                },
                {
                  t: 'Débouchage & Test',
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="mt-12 max-w-4xl mx-auto bg-blue-50 border border-blue-100 rounded-2xl p-8 text-left">
              <h3 className="font-black text-slate-900 text-xl mb-3">Inspection Caméra Endoscopique</h3>
              <p className="text-slate-700 leading-relaxed">
                Si le bouchon persiste ou revient souvent, nous proposons une <strong>inspection vidéo</strong> de vos canalisations.
                Cela permet de visualiser l'intérieur des tuyaux pour détecter une cassure, une racine, un objet coincé
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black mb-6">Tarifs Débouchage</h2>
            <p className="text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              Nos tarifs de <strong>débouchage WC et évier</strong> sont compétitifs et transparents. Le prix varie selon la
              technique nécessaire (manuelle ou haute pression) et l'accessibilité. Le devis est établi sur place
              avant toute intervention.
            </p>
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {["Forfait déplacement", "Débouchage manuel", "Hydrocurage complet"].map((t, i) => (
            ...
            <div className="mt-10 inline-flex items-center gap-3 bg-white/10 px-8 py-5 rounded-2xl">
              ...
              <span className="font-bold">Devis gratuit et sans engagement</span>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  {
                    q: "Mon WC est bouché, c'est urgent ?",
                    a: "Oui, un WC bouché est une urgence sanitaire. N'utilisez plus l'eau et appelez-nous pour éviter le débordement."
                  },
                  {
                    q: "Utilisez-vous de l'acide ?",
                  ...
                  },
                  {
                    ...
                    a: "Oui, nous intervenons partout : appartements, maisons, bureaux, restaurants et commerces."
                  }
                ].map((f, i) => (
