...
const AiDiagnosticModal = ({ isOpen, onClose }) => {
  ...
  const handleAnalyze = async () => {
    ...
    const apiKey = '';
    const prompt = `Act as an expert plumber in Charleroi, Belgium. Analyze this customer issue: "${description}".
    Respond in JSON format ONLY.
    {
      ...
      "estimated_intervention_time": "30-45 min (Charleroi)"
    }`;
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden border border-slate-200">
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-6 flex justify-between items-center text-white">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold">Diagnostic Express Charleroi</h3>
          </div>
        ...
        <div className="p-6">
          {!result ? (
            ...
            <div className="space-y-6">
              ...
              >
                <Phone className="w-6 h-6" /> Appeler l'équipe Charleroi
              </a>
            </div>
          )}
        </div>
...
export default function ZoneCharleroiPage() {
  ...
  return (
    <div className="font-sans text-slate-800 antialiased bg-white selection:bg-orange-500 selection:text-white">
      ...
      <div className="bg-red-600 text-white text-center py-2 px-4 text-xs md:text-sm font-bold">
        Intervention express : Charleroi, Gosselies, Marcinelle, Courcelles, Fleurus.
      </div>
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex gap-6">
            <span className="flex items-center gap-2 text-green-400 font-bold">
              <CheckCircle2 className="w-3.5 h-3.5" /> Plombier Carolo
            </span>
            <span className="flex items-center gap-2">
              <MapPin className="w-3.5 h-3.5" /> Hainaut
            </span>
          </div>
          <div className="flex gap-4">
            ...
            <span className="flex items-center gap-1 text-orange-400 font-bold">
              <Star className="w-3 h-3 fill-current" /> 4.9/5 (Clients Charleroi)
            </span>
          </div>
        </div>
      </div>
      ...
      <main>
        <section className="relative pt-16 pb-24 bg-slate-900 overflow-hidden">
          <div className="absolute inset-0">
            <img
              src="https://images.unsplash.com/photo-1596726857321-dfa3b400977e?auto=format&fit=crop&q=80&w=2000"
              alt="Vue Charleroi"
          ...
          <div className="container mx-auto px-4 relative z-10 text-center lg:text-left">
            ...
            <div className="grid lg:grid-cols-3 gap-6 mt-10 max-w-3xl lg:max-w-4xl">
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
                  <Clock className="w-5 h-5 text-orange-300" /> Rapidité Carolo
                </div>
                <p className="text-slate-200 text-sm mt-2">
                  Nous sommes présents sur Charleroi en permanence pour garantir un délai d'intervention court.
                </p>
              </div>
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              ...
              >
                <Phone className="w-6 h-6" /> Plombier Charleroi
              </a>
              <button
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-black text-slate-900 mb-6 text-center">
              Vos services dans le <span className="text-blue-600">Hainaut</span>
            </h2>
            <p className="text-slate-600 max-w-4xl mx-auto text-center text-lg leading-relaxed">
              Nous intervenons chez les particuliers mais aussi pour les commerces de Rive Gauche,
              les entreprises de l'Aéropole de Gosselies et les syndics d'immeubles.
            </p>
          </div>
        </section>
            ...
            <div className="mt-12 grid lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm">
                <h3 className="font-black text-xl text-slate-900 mb-4 flex items-center gap-2">
                  <Wrench className="w-6 h-6 text-orange-500" /> Plomberie & Rénovation
                </h3>
                <p className="text-slate-600 leading-relaxed mb-4">
                  Remplacement de tuyauteries vétustes (plomb, acier), installation de nouvelles salles de bain,
                  réparation de fuites d'eau ou de gaz. Nous remettons vos installations aux normes.
                </p>
                <ul className="grid grid-cols-2 gap-2 text-sm text-slate-600">
                  ...
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> WC & Chasse</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> Raccordement</li>
                </ul>
              </div>

              <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm">
                <h3 className="font-black text-xl text-slate-900 mb-4 flex items-center gap-2">
                  <Droplets className="w-6 h-6 text-blue-500" /> Débouchage & Curage
                </h3>
                <p className="text-slate-600 leading-relaxed mb-4">
                  Charleroi a un réseau d'égouttage dense et parfois ancien. Nous débouchons tout :
                  toilettes, éviers, sterputs, colonnes d'immeubles. Inspection caméra pour diagnostic précis.
                </p>
                 <ul className="grid grid-cols-2 gap-2 text-sm text-slate-600">
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> Hydrocurage</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> Caméra endoscopique</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> Débouchage WC</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-green-500"/> Nettoyage fosse</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-left">
               <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                 <h3 className="font-bold text-slate-900 mb-2">Détartrage Boiler</h3>
               ...
               <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                 ...
                 <p className="text-sm text-slate-600">
                   La meilleure solution pour protéger vos électroménagers et votre robinetterie du tartre carolo.
                 </p>
               </div>
               <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black mb-6">Tarifs Plombier Charleroi</h2>
            <p className="text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              Prix compétitifs et transparents pour la région de Charleroi.
            </p>
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {["Déplacement Zone Charleroi", "Devis Gratuit sur place", "Garantie intervention"].map((t, i) => (
