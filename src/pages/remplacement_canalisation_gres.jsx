...
const AiDiagnosticModal = ({ isOpen, onClose }) => {
  ...
  const handleAnalyze = async () => {
    ...
    const apiKey = '';
    const prompt = `Act as an expert plumber specializing in sewer pipes and underground drainage. Analyze this customer issue: "${description}".
    Respond in JSON format ONLY.
    {
      "urgency": "Faible" | "Moyenne" | "Haute" | "Critique",
      "safety_tip": "Short immediate advice in French (e.g. Avoid using water, stay away from hole)",
      "service_detected": "Inspection Caméra" or "Remplacement Complet" or "Réparation Locale",
      "estimated_intervention_time": "1 - 3 jours"
    }`;
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden border border-slate-200">
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-6 flex justify-between items-center text-white">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold">Diagnostic Canalisations</h3>
          </div>
          ...
          {!result ? (
            <>
              ...
              >
                ...
                {loading ? 'Analyse en cours...' : "Analyser le terrain"}
              </button>
            </>
          ) : (
            <div className="space-y-6">
              ...
              >
                <Phone className="w-6 h-6" /> Appeler pour devis
              </a>
            </div>
          )}
        </div>
...
export default function RemplacementCanalisationGresPage() {
  ...
  return (
    <div className="font-sans text-slate-800 antialiased bg-white selection:bg-orange-500 selection:text-white">
      ...
      <div className="bg-red-600 text-white text-center py-2 px-4 text-xs md:text-sm font-bold">
        Rénovation et remplacement d'égouts cassés ou effondrés. Devis sur mesure.
      </div>
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex gap-6">
            <span className="flex items-center gap-2 text-green-400 font-bold">
              <CheckCircle2 className="w-3.5 h-3.5" /> Terrassement compris
            </span>
          ...
          <div className="flex gap-4">
            ...
            <span className="flex items-center gap-1 text-orange-400 font-bold">
              <Star className="w-3 h-3 fill-current" /> 5/5 (Expertise)
            </span>
          </div>
        </div>
      </div>
        ...
        <section className="relative pt-16 pb-24 bg-slate-900 overflow-hidden">
          <div className="absolute inset-0">
            <img
              ...
              alt="Chantier remplacement canalisation"
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-12 grid lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl border border-slate-100 p-7 shadow-sm">
                ...
                <ul className="space-y-3 text-slate-600 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Joints rigides qui cassent au moindre mouvement de sol</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-red-600 mt-0.5" />
                    <span>Parois rugueuses qui retiennent le papier et les graisses</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-red-600 mt-0.5" />
                    <span>Racines qui s'infiltrent et font éclater le tuyau</span>
                  </li>
                </ul>
              </div>

              <div className="bg-white rounded-2xl border border-slate-100 p-7 shadow-sm">
                <h3 className="font-black text-lg text-slate-900 mb-3">Avantages du PVC/PE</h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-4">
                  Les nouveaux matériaux offrent une étanchéité absolue et une surface lisse qui favorise l'auto-curage.
              ...
              <div className="bg-white rounded-2xl border border-slate-100 p-7 shadow-sm">
                <h3 className="font-black text-lg text-slate-900 mb-3">Inspection préalable</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
                  Avant de creuser, nous passons souvent la <strong>caméra</strong> pour localiser précisément la cassure ou l'effondrement.
                  Cela permet de limiter l'ouverture du sol au strict nécessaire.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                ...
                et créer des vides sous vos terrasses ou allées (risque d'affaissement).
              </p>
              <ul className="space-y-4">
                {[
                  'Fin des bouchons récurrents',
                  "Plus de mauvaises odeurs dans la maison",
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-4 gap-8 text-left">
              {[
                ...
                {
                  t: 'Terrassement',
                  d: 'Ouverture de la tranchée (manuelle ou mini-pelle) avec précaution pour les autres impétrants (gaz, élec).'
                },
                {
                ...
                },
                {
                  ...
                  d: "Remblaiement par couches compactées. Réfection du béton, des pavés ou de la pelouse."
                }
              ].map((s, i) => (
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black text-slate-900 mb-12">
              Chambres de visite & <span className="text-blue-600">Accessibilité</span>
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              {['Installation chambre visite', 'Réhausse de regard', 'Clapet anti-retour'].map((item, i) => (
                <div key={i} className="p-8 bg-slate-50 rounded-2xl border border-slate-100">
                  <Construction className="w-10 h-10 text-blue-600 mx-auto mb-4" />
                  <h3 className="font-black text-lg mb-2">{item}</h3>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Nous profitons du remplacement des tuyaux pour installer des <strong>chambres de visite</strong> accessibles.
                    Cela facilitera grandement l'entretien futur et les inspections. Nous posons aussi des clapets anti-retour pour éviter les refoulements.
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="mt-10 inline-flex items-center gap-3 bg-white/10 px-8 py-5 rounded-2xl">
              ...
              <span className="font-bold">Demandez votre visite gratuite</span>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  {
                    q: "Faut-il casser tout le sol ?",
                    a: "Pas toujours. Nous pouvons parfois faire un chemisage (réparation par l'intérieur) si le tuyau n'est pas effondré."
                  },
                  {
