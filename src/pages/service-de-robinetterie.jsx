...
const AiDiagnosticModal = ({ isOpen, onClose }) => {
  ...
  const handleAnalyze = async () => {
    ...
    const apiKey = '';
    const prompt = `Act as an expert plumber specializing in faucets, taps, and mixers. Analyze this customer issue: "${description}".
    Respond in JSON format ONLY.
    {
      "urgency": "Faible" | "Moyenne" | "Haute",
      "safety_tip": "Short immediate advice in French (e.g. Turn off angle valve)",
      "service_detected": "Remplacement" or "Réparation" or "Détartrage",
      "estimated_intervention_time": "1h"
    }`;
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden border border-slate-200">
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-6 flex justify-between items-center text-white">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold">Diagnostic Robinetterie</h3>
          </div>
        ...
        <div className="p-6">
          {!result ? (
            ...
            <div className="space-y-6">
              ...
              >
                <Phone className="w-6 h-6" /> Appeler le Plombier
              </a>
            </div>
          )}
        </div>
...
export default function ServiceRobinetteriePage() {
  ...
  return (
    <div className="font-sans text-slate-800 antialiased bg-white selection:bg-orange-500 selection:text-white">
      ...
      <div className="bg-red-600 text-white text-center py-2 px-4 text-xs md:text-sm font-bold">
        Installation et réparation de robinetterie toutes marques. Intervention rapide.
      </div>
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex gap-6">
            <span className="flex items-center gap-2 text-green-400 font-bold">
              <CheckCircle2 className="w-3.5 h-3.5" /> Garantie Installation 2 ans
            </span>
      ...
      <main>
        <section className="relative pt-16 pb-24 bg-slate-900 overflow-hidden">
          <div className="absolute inset-0">
            <img
              src="https://images.unsplash.com/photo-1585909695175-e23971c6683f?auto=format&fit=crop&q=80&w=2070"
              alt="Installation robinetterie moderne"
          ...
          <div className="container mx-auto px-4 relative z-10 text-center lg:text-left">
            <span className="inline-flex items-center gap-2 bg-blue-600/20 text-blue-300 px-4 py-2 rounded-full text-sm font-bold mb-6">
              <Settings className="w-4 h-4" /> Installation & Rénovation
            </span>
            <h1 className="text-4xl lg:text-6xl font-black text-white mb-6">
              Service de <span className="text-orange-500">Robinetterie</span>
              <br />
              & Mitigeurs
            </h1>
            <p className="text-xl text-slate-300 max-w-3xl lg:max-w-2xl">
              Un robinet qui fuit, un mitigeur grippé ou envie de moderniser votre salle de bain ?
              Nos plombiers assurent l'<strong>installation</strong>, le <strong>remplacement</strong> et la <strong>réparation</strong>
              de toute votre robinetterie (cuisine, bain, douche) avec des marques de qualité.
            </p>
            ...
            <div className="grid lg:grid-cols-3 gap-6 mt-10 max-w-3xl lg:max-w-4xl">
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
                  <Clock className="w-5 h-5 text-orange-300" /> Pose rapide
                </div>
                <p className="text-slate-200 text-sm mt-2">
                  Nous avons un stock de joints et cartouches pour les réparations courantes. Installation sur rendez-vous rapide.
                </p>
              </div>
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
                  <ShieldCheck className="w-5 h-5 text-green-300" /> Marques Pro
                </div>
                <p className="text-slate-200 text-sm mt-2">
                  Installation certifiée de marques reconnues (Grohe, Hansgrohe, etc.) ou pose de votre matériel.
                </p>
              </div>
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-black text-slate-900 mb-12 text-center">
              Nos interventions <span className="text-blue-600">Robinetterie</span>
            </h2>
            ...
            <div className="mt-12 grid lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl border border-slate-100 p-7 shadow-sm">
                <h3 className="font-black text-lg text-slate-900 mb-3">Quand remplacer ?</h3>
                <ul className="space-y-3 text-slate-600 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
                    <span>Le robinet goutte malgré le changement de joint</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-green-600 mt-0.5" />
              ...
              <div className="bg-white rounded-2xl border border-slate-100 p-7 shadow-sm">
                <h3 className="font-black text-lg text-slate-900 mb-3">Nos marques partenaires</h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-4">
                  Nous installons toutes les marques, mais recommandons la qualité pour la longévité :
                </p>
                <div className="flex flex-wrap gap-2">
                  {['Grohe', 'Hansgrohe', 'Delabie', 'Franke', 'Blanco'].map((brand, i) => (
          ...
          <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Nos plombiers assurent une étanchéité parfaite, fixent solidement le robinet (pas de jeu), et raccordent
                les flexibles sans torsion. Nous nous occupons aussi des bondes et des siphons.
              </p>
            ...
            <div className="relative flex justify-center">
              <img
                ...
                alt="Plombier installant un robinet de cuisine"
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black text-slate-900 mb-4">
              Déroulement de l'<span className="text-blue-600">installation</span>
            </h2>
            <p className="text-slate-600 mb-12 max-w-3xl mx-auto">
              Une intervention propre et soignée pour embellir votre cuisine ou salle de bain.
            </p>
            <div className="grid md:grid-cols-4 gap-8 text-left">
              {[
                {
                  t: 'Diagnostic / Choix',
                  d: "On identifie le type de robinet nécessaire (entraxe, hauteur) ou on répare l'existant."
                },
                {
                  t: 'Coupure et Démontage',
                  d: 'Coupure d\'eau sécurisée. Démontage de l\'ancien robinet (souvent grippé) avec dégrippant pro.'
                },
                {
                ...
                },
                {
                  ...
                  d: "Vérification de l'absence de fuite, test de débit et réglage de la température."
                }
              ].map((s, i) => (
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {['Clés à bonde', 'Graisse silicone', 'Clés lisses chromées'].map((item, i) => (
                <div key={i} className="p-8 bg-slate-50 rounded-2xl border border-slate-100">
                  ...
                  <h3 className="font-black text-lg mb-2">{item}</h3>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Nous utilisons un outillage spécifique pour démonter les écrous inaccessibles sous l'évier
                    et préserver l'esthétique de votre robinetterie neuve.
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black mb-6">Tarifs Robinetterie</h2>
            <p className="text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              Des forfaits clairs pour la pose ou la réparation. Que vous fournissiez le robinet ou que nous l'apportions,
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    a: "C'est souvent la cartouche thermostatique qui est entartrée. Nous pouvons tenter un nettoyage ou la remplacer."
                  },
                  {
        ...
        <section className="py-20 bg-orange-600 text-white text-center">
          <h2 className="text-3xl font-black mb-4">Besoin d'un nouveau robinet ?</h2>
          <p className="mb-8 text-lg">Contactez Aqua&Deb pour une installation soignée et durable.</p>
          <a
            href={BRAND.phoneLink}
