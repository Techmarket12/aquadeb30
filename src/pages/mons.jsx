...
const AiDiagnosticModal = ({ isOpen, onClose }) => {
  ...
  const handleAnalyze = async () => {
    ...
    const apiKey = '';
    const prompt = `Act as an expert plumber in Mons, Belgium. Analyze this customer issue: "${description}".
    Respond in JSON format ONLY.
    {
      ...
      "estimated_intervention_time": "30-45 min (Mons)"
    }`;
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden border border-slate-200">
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-6 flex justify-between items-center text-white">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold">Diagnostic Express Mons</h3>
          </div>
        ...
        <div className="p-6">
          {!result ? (
            ...
            <div className="space-y-6">
              ...
              >
                <Phone className="w-6 h-6" /> Appeler l'équipe Mons
              </a>
            </div>
          )}
        </div>
...
export default function ZoneMonsPage() {
  ...
  return (
    <div className="font-sans text-slate-800 antialiased bg-white selection:bg-orange-500 selection:text-white">
      ...
      <div className="bg-red-600 text-white text-center py-2 px-4 text-xs md:text-sm font-bold">
        Intervention express : Mons, Jemappes, Cuesmes, Saint-Ghislain, Binche.
      </div>
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex gap-6">
            <span className="flex items-center gap-2 text-green-400 font-bold">
              <CheckCircle2 className="w-3.5 h-3.5" /> Plombier Montois
            </span>
            <span className="flex items-center gap-2">
              <MapPin className="w-3.5 h-3.5" /> Région du Centre
            </span>
          </div>
          <div className="flex gap-4">
            ...
            <span className="flex items-center gap-1 text-orange-400 font-bold">
              <Star className="w-3 h-3 fill-current" /> 4.9/5 (Clients Mons)
            </span>
          </div>
        </div>
      </div>
      ...
      <main>
        <section className="relative pt-16 pb-24 bg-slate-900 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center lg:text-left">
            ...
            <div className="grid lg:grid-cols-3 gap-6 mt-10 max-w-3xl lg:max-w-4xl">
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                ...
                <p className="text-slate-200 text-sm mt-2">
                  Nos techniciens connaissent bien la région pour intervenir vite, du centre historique aux zonings périphériques.
                </p>
              </div>
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
                  <ShieldCheck className="w-5 h-5 text-green-300" /> Savoir-Faire
                </div>
                <p className="text-slate-200 text-sm mt-2">
                  Spécialistes de la rénovation sanitaire et du dépannage urgent dans la région du Doudou.
                </p>
              </div>
              <div className="bg-white/10 border border-white/10 rounded-2xl p-5 text-left">
                <div className="flex items-center gap-3 text-white font-black">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              ...
              >
                <Phone className="w-6 h-6" /> Plombier Mons
              </a>
              <button
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <p className="text-slate-600 max-w-4xl mx-auto text-center text-lg leading-relaxed">
              ...
              comme pour les commerces des Grands Prés et du piétonnier.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {['Débouchage Jemappes', 'Fuite Cuesmes', 'Chauffage Saint-Ghislain', 'Sanitaire Binche'].map((item, i) => (
          ...
          <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-black text-slate-900 mb-6">
                Zones desservies autour de <span className="text-red-600">Mons</span>
              </h2>
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                Notre équipe rayonne depuis Mons vers toutes les communes avoisinantes,
                du Borinage jusqu'au Centre.
              </p>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-left">
               ...
               <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                 ...
                 <p className="text-sm text-slate-600">
                   L'eau de Mons est dure (calcaire). L'entretien régulier du boiler est crucial pour la sécurité et l'économie d'énergie.
                 </p>
               </div>
               <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
        ...
        <section className="py-20 bg-slate-900 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-black mb-6">Tarifs Plombier Mons</h2>
            <p className="text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
              Prix clairs et compétitifs pour toute la région de Mons.
            </p>
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {["Déplacement Zone Mons", "Devis Gratuit sur place", "Garantie travail"].map((t, i) => (
