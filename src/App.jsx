          ...
          <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                {["Services de plomberie", "Services de débouchage", "Dépannage plomberie", "Rénovation plomberie", "Entretien plomberie"].map((item, i) => (
